...
<p align="center">
    <picture>
        <!--- Forced colors --->
        <source media="(forced-colors: active) and (prefers-color-scheme: light) and (min-width: 1200px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-light-full">
        <source media="(forced-colors: active) and (prefers-color-scheme: light) and (min-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-light-medium">
        <source media="(forced-colors: active) and (prefers-color-scheme: light) and (max-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-light-small">
        <source media="(forced-colors: active) and (prefers-color-scheme: dark) and (min-width: 1200px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-dark-full">
        <source media="(forced-colors: active) and (prefers-color-scheme: dark) and (min-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-dark-medium">
        <source media="(forced-colors: active) and (prefers-color-scheme: dark) and (max-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-forced_colors-dark-small">
        <!--- Main queries --->
        <source media="(prefers-color-scheme: light) and (min-width: 1200px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-full">
        <source media="(prefers-color-scheme: light) and (min-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-medium">
        <source media="(prefers-color-scheme: light) and (max-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-small">
        <source media="(prefers-color-scheme: dark) and (min-width: 1200px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-full">
        <source media="(prefers-color-scheme: dark) and (min-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-medium">
        <source media="(prefers-color-scheme: dark) and (max-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-small">
        <!--- Fallback queries --->
        <source media="(prefers-color-scheme: light)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-full">
        <source media="(prefers-color-scheme: dark)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-full">
        <source media="(min-width: 1200px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-full">
        <source media="(min-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-dark-medium">
        <source media="(max-width: 800px)" srcset="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-small">
        <img type="image/svg+xml" alt="Harole, a quirky hobbyist." src="https://harole.npkn.net/harole-landing-illustration/occasions-normal-light-full>" width="900" height="100%" >
    </picture>
</p>
...
<p align="center">
    <picture>
        ...
        <source media="(any-pointer: coarse)" type="image/png" srcset="./assets/quick%20links/Frag%20Empty.png">
        <img aria-hidden type="image/png" src="./assets/quick%20links/Frag%20Empty.png" height="16">
    </picture>
</p>
...
<picture>
    <source media="(prefers-color-scheme: light)" srcset="./assets/illustrations/Harole%20Working%20on%20Laptop.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/illustrations/Harole%20Working%20on%20Laptop%20Dark.svg">
    ...
    <p align="center">
        <a href="https://github.com/HaroleDev/haroleethan-iframes/tree/main/Web%20Player%20Snippet">
            <picture>
                ...
                <img type="image/png" alt="Playful Video Player Illustration with a boundless frame" src="./assets/illustrations/projects/Playful%20VP/Playful%20VP%20Boundless%20Light.png" width="1200">
            </picture>
        </a>
    </p>
    <h3 align="center">
    ...
    <p align="center">
        <a href="https://github.com/HaroleDev/Airycons">
            <picture>
                ...
                <img type="image/png" alt="Airycons table of icons with a boundless frame" src="./assets/illustrations/projects/Airycons/Airycons%20Boundless%20Light.png" width="1070">
            </picture>
        </a>
    </p>
    <h3 align="center">
